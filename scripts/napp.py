...
def get_user_ap_diff(apnames, logger):
    ...
    for cip, apnames in apnames.items():
        ...
        exportdata[cip]['diff_user_count'] = diffuser
        ...
        for apname in apnames:
            ...
            exportdata[cip][apname] = data_usertable_apname_count[1][1:]
